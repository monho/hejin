...
function ContactButton({ person, account, kakaopay }) {
  ...
  function Account() {
    const groom_contact = [
      { person: "신랑 최영민 , 신부 방혜진", account: "카카오뱅크 333-2186-485-17", kakaopay: "" },
      
    ];

    const bride_contact = [
        // { person: "신부 방혜진", account: "카카오뱅크 333-2186-485-17" , kakaopay: "" },
        { person: "아버지 최권호 , 어머니 손유정", account: "경남은행 05-22-0138232", kakaopay: "" },
        { person: "아버지 방보섭 , 어머니 홍경자", account: "우체국은행 613687-02-048716", kakaopay: ""},
      ];
